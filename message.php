      ...
      $stmt->execute();
                ...
                try {
                  ...
                  while ($row = $stmt->fetch()) {  
                    ...
                    print "<tr><td>".$row[0]."</td><td>" . $row[2]."</td><td> " .$row[3] . "</td><td><span class='v'>".$row[4] . "</span></td><td>".$row[5] . "</td> <td><input type='checkbox' id='scales' name='option[]' value='$row[6]'></td></tr>" ;
                   if($row[4]=='probleme non resolu')
                   print "<tr><td>".$row[0]."</td><td>" . $row[2]."</td><td> " .$row[3] . "</td><td><span >".$row[4] . "</span></td><td>".$row[5] . "</td><td><input type='checkbox' id='scales' name='option[]' value='$row[6]'></td></tr>" ;
