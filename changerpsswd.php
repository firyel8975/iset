        ...
        <div class="signup-content">
            <div class="signup-form">
                ...
                <form method="POST" class="register-form" id="register-form">
                        ...
                        <input type="password" name="code" id="code" placeholder="ancien mot de passe"/>
                       </div>
                    <div class="form-group">
            ...
            <div class="signup-image">
               <?php if($_SESSION['rol']==="enseignant")
               echo" <a href='espaceENS.php' class='signup-image-link'>Mon espace</a>"
                ?>
                <?php if($_SESSION['rol']==="technicien")
                echo "<a href='espaceTECH.php' class='signup-image-link'>Mon espace</a>" ?>
<?php
