...
tr{ color:white}
tr:hover {background-color: #C5C392;}
.pos{}
...
<div  style="background-color:#0f0f0f;" class="container emp-profile">
            <form method="post">
                ...
                <table border="1 solid"><tr><th>Prof</th><th >Email</th><th >Numéro de téléphone</th></tr>
                <?php
                  $sql = "SELECT pseudo, mail,num  FROM membres WHERE rol='enseignant'";
  ...
  <div class="dropdown-content">
    <a href="espaceTECH.php">Profil</a>
